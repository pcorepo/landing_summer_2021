        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    ...
                    <h2 class="section blue-luiss">Test di ammissione - Approccio introduttivo e simulazioni riservate agli iscritti alla Orientation 4 Summer School 2021</h2>
                </div>


                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">Per tutti gli studenti già iscritti alla Luiss Orientation 4 Summer School, a partire dal mese di aprile, sarà possibile partecipare a un ciclo di incontri on-line dedicati a simulazioni del test di ammissione Luiss.
                        <br><br>
                        Gli studenti riceveranno direttamente il link di partecipazione in prossimità dell’evento.<br><br>
                        Calendario
                    </p>
                    
                    <div class="container mx-auto p-0 border-0 table-responsive">
                    <table id="table-content" class="ml-0 table blue-luiss">
                        <tbody>
                            <tr>
                                <th class="text-center" colspan="2"><b>Data</b></th>
                                <th class="text-center"><b>Orario</b></th>
                                <th class="text-center"><b>Argomento</b></th>
                            </tr>
                            <tr>
                                <td>Giovedì</td>
                                <td class="text-center">8 aprile 2021</td>
                                <td class="text-center">15:00-17:00</td>
                                <td>1. Simulazione del test di Ammissione Luiss</td>
                            </tr>
                            <tr>
                                <td>Giovedì</td>
                                <td class="text-center">22 aprile 2021</td>
                                <td class="text-center">15:00-17:00</td>
                                <td>2. Simulazione del test di Ammissione Luiss</td>
                            </tr>
                            <tr>
                                <td>Giovedì</td>
                                <td class="text-center">6 maggio 2021</td>
                                <td class="text-center">15:00-17:00</td>
                                <td>3. Simulazione del test di Ammissione Luiss</td>
                            </tr>
                            <tr>
                                <td>Giovedì</td>
                                <td class="text-center">20 maggio 2021</td>
                                <td class="text-center">15:00-17:00</td>
                                <td>4. Simulazione del test di Ammissione Luiss</td>
                            </tr>
                            <tr>
                                <td>Giovedì</td>
                                <td class="text-center">3 giugno 2021</td>
                                <td class="text-center">15:00-17:00</td>
                                <td>5. Simulazione del test di Ammissione Luiss</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
