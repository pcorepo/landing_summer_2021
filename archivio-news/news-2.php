        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    ...
                    <h2 class="section blue-luiss">Luiss Summer School 2021</h2>
                </div>
                <!-- <div class="col-12 photo-page photo-news1">
				</div> -->
                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">Cari studenti e genitori,
                        <br><br>
                        stiamo definendo il calendario l’offerta formativa per l’estate del 2021. Entro fine anno pubblicheremo in queste pagine ulteriori dettagli.
                        <br><br>
                        Per essere informati su tutte le novità potete compilare il seguente form <a href="https://landing.luiss.it/summer-school-2021/contattaci.php">qui</a>.
                    </p>
                </div>
            </div>
        </div>
