        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    ...
                    <h2 class="section blue-luiss">Test di Ammissione Orientation 4: fissata la soglia di ingresso a 55/100</h2>
                </div>
                
                
                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">Si comunica che la soglia minima per il superamento del test di ammissione della Orientation 4, è stata fissata - in via del tutto eccezionale per l'edizione 2020 - a 55/100, invece dei tradizionali 65/100.
                    </p>
                </div>
            </div>
        </div>
