        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <p class="blue-luiss">27 Ottobre 2020</p>
                    <h2 class="section blue-luiss">Incontri on line per borse di studio per l’edizione 2021</h2>
                </div>
                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">
                        A partire da novembre, appuntamenti periodici per ottenere una borsa di studio Luiss Summer School per l’edizione 2021.
                        <br><br>
                        Maggiori informazioni <a href="https://landing.luiss.it/summer-school-2021/borse-di-studio-2021.php"><b>qui<b/>
                        </b></a></p>
                </div>
            </div>
