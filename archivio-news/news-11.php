...
<head>
    <title>News | Luiss Summer Schools 2021</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <p class="blue-luiss"></p>
                    <h2 class="section blue-luiss">Emergenza Covid 2019: le Summer School 2020 si svolgeranno comunque. Scopri le modalità e il Calendario</h2>
                </div>


                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">Si comunica che le Summer School del 2020 si svolgeranno comunque. Nel caso in cui le condizioni sanitarie non consentissero di effettuarle in presenza, tutti i corsi saranno tenuti on-line in modo interattivo dai medesimi docenti, secondo le stesse modalità attualmente usate per i nostri studenti universitari. Sarà garantita anche la preparazione e la prova di ammissione anticipata alla Luiss nella Orientation 4 e la prova per il riconoscimento del bonus di 5 punti sull’ammissione per la Orientation 3. In tal caso, tutti gli iscritti in formula residenziale avranno la possibilità di ottenere il rimborso della maggiorazione relativa alla residenzialità. Inoltre, per coloro che per qualunque motivo vogliono essere certi di poter frequentare la Summer School a distanza, senza venire alla Luiss, sono state inserite nel calendario due settimane in cui i corsi e il test finale saranno comunque tenuti online, una per la Orientation 3 ed una per la Orientation 4. Consulta il <a href="../calendario.php">Calendario</a> per maggiori informazioni.
                    </p>
                </div>
            </div>
        </div>
