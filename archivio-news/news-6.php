        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    ...
                    <h2 class="section blue-luiss">Open day on line per le Summer School 2020<br> Riguarda il video della diretta</h2>
                </div>


                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">
                        <b>Incontro interattivo di presentazione delle Summer School 2020</b><br><br>

                        Intervengono:<br>
                        • Andrea Prencipe, Rettore - Luiss <br>
                        • Roberto Costantini, Direttore Summer School & Luiss Hubs - Luiss <br> <br>

                        Testimonianze di studenti e laureati che hanno frequentato le Luiss Summer School negli scorsi anni<br> <br>

                        Modera:<br>
                        Francesco Giorgino, Professore Luiss e Professor of practice della Luiss School of Government<br> <br>

                        <i> Sarà possibile interagire e porre domande tramite chat.</i> <br> <br>

                        <b>E' possibile rivedere la diretta Facebook alla pagina <a href=" https://www.facebook.com/watch/live/?v=256555745586929" target="_blank">Luiss Summer School</a></b>
                    </p>
                </div>
            </div>
        </div>
