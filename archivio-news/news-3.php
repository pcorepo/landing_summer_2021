        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    ...
                    <h2 class="section blue-luiss">Test Summer School 2020: i risultati saranno disponibili entro fine settembre</h2>
                </div>


                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">"A conclusione di tutte le edizioni della Luiss Summer School 2020, che sono terminate l'11 settembre, sarà effettuata la correzione del Test di ammissione della <b>Orientation 4</b> e del Test finale di apprendimento della <b>Orientation 3 </b>. <br>
                        I risultati saranno disponibili entro la fine del mese di settembre."
                    </p>
                </div>
            </div>
        </div>
