...
<head>
    <title>L'offerta 2021| Luiss Summer Schools 2021</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container px-0 blue-luiss-border">
        <div class="embed-responsive embed-responsive-16by9">
            <!--			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sOM9g5OJkEk?rel=0" allowfullscreen></iframe>-->
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/6gZgfkD7I8c?rel=0" allowfullscreen></iframe>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <h2 class="section blue-luiss">L’offerta Summer School 2021</h2>
                </div>
                <div class="col-12 col-md-8 mx-auto course">
                    <button class="blue-luiss blue-luiss-border mb-3" onclick="location.href='index.html#scegli-summer-school'">SCOPRI I PERCORSI 2021<i class="fas fa-arrow-right"></i></button>
                    <p class="big blue-luiss">
                        Da oltre 10 anni la Luiss propone dei programmi estivi rivolti agli studenti delle Scuole Superiori che consentono di iniziare <strong>un percorso di ingresso in Luiss già a partire dal terzultimo anno scolastico.</strong>
                    </p>

                    <p class="big blue-luiss">
                        Frequentando la <strong><a href="orientation-3-summer-school.php">Orientation 3</a></strong> al terzultimo anno delle Superiori, è possibile ottenere attraverso un test finale di apprendimento 5 punti di bonus da utilizzare l’estate successiva durante il test di ammissione alla Luiss che verrà sostenuto al termine della Orientation 4.
                    </p>

                    <p class="big blue-luiss">
                        Per gli studenti al penultimo anno delle Superiori, la <strong><a href="orientation-4-summer-school.php">Orientation 4</a></strong> consente di sostenere con un anno di anticipo il test di ammissione alla Luiss. Chi supera il test, avrà tempo fino all’autunno 2021 per scegliere il Corso di Laurea Luiss a cui iscriversi. La soglia minima per il superamento del test anticipato è stata fissata - anche per l'edizione 2021 - a 55/100.
                    </p>

                    <p class="big blue-luiss">
                        Per gli studenti dal primo al penultimo anno delle Superiori sono disponibili due percorsi che consentono di vivere esperienze intensive e concrete a contatto con settori di grande attualità.<br>
                        La Writing Summer School permette di entrate in contatto con il mondo della sceneggiatura e delle serie televisive.<br>
                        La Coding 42 Summer School introduce al mondo della programmazione grazie ad un linguaggio di semplice comprensione come il python.
                        <br>
                        Questi percorsi non prevedono né prove finali né l’accesso in Luiss.
                    </p>

                    <p class="big blue-luiss">
                        <strong>I percorsi delle Luiss Summer School sono distribuiti su tutta l’estate e sono fruibili anche a distanza in alcune settimane.</strong>
                    </p>
                    <button class="blue-luiss blue-luiss-border mb-3" onclick="location.href='index.html#scegli-summer-school'">SCOPRI I PERCORSI 2021<i class="fas fa-arrow-right"></i></button>
