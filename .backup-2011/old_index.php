...
$sticky4 = getNews('UID94970');
$sticky3 = getNews('UID80889');
...
<body>
	...
	<section class="second-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-12 col-md-6 py-4 neworld">
					<div class="header-stripe neworld-stripe"></div>
					<div class="min-height">
						<h3 class="school color-neworld"> <strong>Luiss</strong> <br />NeWorld</h3>
						<h3 class="school color-neworld"><strong>Summer School</strong></h3>
						<p class="small blue-luiss my-3"> <strong>Per studenti del primo e secondo anno</strong> <br />Comprendere le tecnologie del futuro (Intelligenza Artificiale, Robotica, Droni, Realtà Aumentata) ed esaminare le ricadute sociali, economiche e giuridiche che le innovazioni determineranno nella vita quotidiana, anche dal punto di vista etico.</p>
					</div>
					<a class="call blue-luiss" title="" href="neworld-summer-school.php">Vai al corso</a>
				</div>
				<div class="col-12 col-md-6 py-4 nextgen">
					<div class="header-stripe nextgen-stripe"></div>
					<div class="min-height">
						<h3 class="school color-nextgen"><strong>Luiss</strong> <br /> Next Generation</h3>
						<h3 class="school color-nextgen"><strong>Summer School</strong></h3>
						<p class="small blue-luiss my-3"> <strong>Per studenti delle scuole medie</strong> <br /> Apprendere, attraverso il gioco e il coding, strategie per risolvere problemi, creare progetti e comunicare le proprie idee e intuizioni.</p>
					</div>
					<a class="call blue-luiss" title="" href="next-generation-summer-school.php">Vai al corso</a>
				</div>
			</div>
			<div class="row">
			...
			<div class="row blue-luiss">
				...
				<div class="col-12 col-md-3 mb-5">
					...
					<div class="min-height">
						...
						<p class="big">Partecipa al prossimo <strong>Open day on line sabato 30 maggio, ore 15:00</strong></p>
					</div>
