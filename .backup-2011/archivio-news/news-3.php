        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
					<p class="blue-luiss">5 Maggio 2020 / 22 maggio 2020</p>
                    <h2 class="section blue-luiss">"Come potenziare le abilità di studio"</h2>
                </div>
				<div class="col-12 photo-page photo-news1">
                </div>
                <div class="col-12 col-md-8 mx-auto my-4">
                    <p class="big blue-luiss">Corso di preparazione organizzato in un ciclo di 6 incontri bisettimanali, dedicato alla preparazione alla prova finale della Orientation 3 Summer School</p>
					</div>
            </div>
