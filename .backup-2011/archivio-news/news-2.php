...
<head>
	<title>News | Luiss Summer Schools 2020</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
		...
		<div id="news" class="container">
			<div class="row">
				<div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
					...
					<h2 class="section blue-luiss">Preparazione al test di ammissione</h2>
				</div>
				<!-- <div class="col-12 photo-page photo-news1">
				</div> -->
				<div class="col-12 col-md-8 mx-auto my-4">
					<p class="big blue-luiss">Ciclo di incontri di preparazione al test di ammissione riservato agli studenti iscritti alla Orientation 4</p>
				</div>
						...
						<tbody>
							<tr>
								<td class="border-bottom">
									<p class="big blue-luiss"><b>8 aprile 2020 - Preparazione al test di ammissione</b></p>
								</td>
								<td class="border-bottom">
									<p class="big blue-luiss">Ore 16:00 – 17:00 - Simulazione test 35 domande</p>
									<p class="big blue-luiss">Ore 17:00 – 17:10 - Vinci una borsa di studio Summer School</p>
									<p class="big blue-luiss">Ore 17:10 – 17:30 - Correzione commentata della simulazione</p>
								</td>
							</tr>
							<tr>
								<td class="border-bottom">
									<p class="big blue-luiss"><b>15 aprile 2020 - Preparazione al test di ammissione</b></p>
								</td>
								<td class="border-bottom">
									<p class="big blue-luiss">Ore 16:00 – 17:00 - Prima simulazione test on line</p>
									<p class="big blue-luiss">Ore 17:00 – 17:20 - Vinci una borsa di studio Summer School</p>
									<p class="big blue-luiss">Ore 17:20 – 18:00 - Correzione commentata della simulazione</p>

								</td>
							</tr>
							<tr>
								<td class="border border-white">
									<p class="big blue-luiss"><b>22 aprile 2020 - Preparazione al test di ammissione</b></p>
								</td>
								<td class="border border-white">
									<p class="big blue-luiss">Ore 16:00 – 17:00 - Seconda simulazione test on line</p>
									<p class="big blue-luiss">Ore 17:00 – 17:20 - Vinci una borsa di studio Summer School</p>
									<p class="big blue-luiss">Ore 17:20 – 18:00 - Correzione commentata della simulazione</p>
								</td>
							</tr>
