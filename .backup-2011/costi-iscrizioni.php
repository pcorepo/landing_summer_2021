...
<head>
    <title>Costi e Modalità di iscrizione | Luiss Summer Schools 2020</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <p class="red-news">IN VIA DI DEFINIZIONE PER L’EDIZIONE 2021 </p>
                    <h2 class="section blue-luiss">Costi e Modalità di iscrizione 2020</h2>
                </div>
                <div class="col-12 col-md-8 mx-auto course">
                    <p class="big blue-luiss">La quota di partecipazione è di euro 1.200 (iva inclusa) per la Orientation 4 e di euro 900 (iva inclusa) per tutte le altre Summer School (Orientation 3, NeWorld, NeWorld Junior, Next Generation, Writing).</p>
                    <p class="big blue-luiss">La formula residenziale (comprensiva di vitto e alloggio per l’intero soggiorno) prevede una maggiorazione di euro 300 (iva compresa).</p>
                    <p class="big blue-luiss">Non sono previsti termini per l’effettuazione dell’iscrizione ma, una volta raggiunto il numero massimo di partecipanti per ciascuna edizione, le iscrizioni verranno chiuse e ci si potrà iscrivere solo a uno dei corsi ancora disponibili.</p>
                    <p class="big blue-luiss">Una volta completata l’iscrizione, si hanno 7 giorni di tempo per effettuare il pagamento della quota di partecipazione. Decorso tale termine, il posto prenotato e non ancora pagato non è più garantito e potrà essere assegnato ad altro partecipante.</p>
					<button class="call blue-luiss blue-luiss-border" onclick="window.location.href='http://jsa.luiss.it/Summer/'">Iscriviti qui <i class="fas fa-arrow-right"></i></button>
                </div>
            </div>
