...
<head>
    <title>Borse di studio | Luiss Summer Schools 2020</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <h2 class="section blue-luiss">Borse di studio e Progetto 9000</h2>
                    <p class="red-news">LE MODALITA’ DI ASSEGNAZIONE DELLE BORSE DI STUDIO SONO IN VIA DI DEFINIZIONE </p>
                </div>
                <div class="col-12 col-md-8 mx-auto course">
                    <p class="big blue-luiss">Gli studenti del penultimo anno che superano il test al termine della Orientation 4 con un punteggio eccellente e che conseguono al termine dell’ultimo anno un voto di diploma di Maturità altrettanto meritevole possono avvalersi del progetto 9000 che prevede l’esonero totale dal pagamento del Contributo Unico per l’iscrizione al primo anno di un Corso di Laurea Luiss Triennale o Magistrale a ciclo unico nell’a. a. 2021/2022.</p>

                    <p class="big blue-luiss">Le Borse di studio, in numero illimitato, vengono concesse infatti a tutti gli studenti che avranno ottenuto un punteggio pari o superiore a 9000, calcolato moltiplicando il risultato personale del test di ammissione al termine della Orientation Summer School, espresso in centesimi, per il voto ottenuto all'esame di maturità.</p>

                    <p class="big blue-luiss">Il Progetto 9000 permette inoltre di estendere l'esonero anche alle rette degli anni successivi al primo, a condizione di essere in regola con gli esami con una media non inferiore a 28/30</p>
