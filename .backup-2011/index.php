		...
		<div class="container py-5 my-md-5">
			<div class="row py-xs-3 my-xs-3 py-5 ">
				...
				<div class="col-12 col-md-6">
					<p class="big white">L’offerta Luiss Summer School 2021 è in fase di definizione. Tutte le informazioni sui corsi, le date e i costi saranno disponibili nel corso delle prossime settimane</p>
					<button style="border: 2px solid #fff;" onclick="location.href='https://landing.luiss.it/summer-school-2021/contattaci.php'">
						RIMANI AGGIORNATO <i class="fas fa-arrow-right white"></i>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="row blue-luiss">
				<div class="col-12 col-md-4 mb-5">
					<div class="embed-responsive embed-responsive-16by9 mb-3">
						<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/h5ndnO3Zt00" allowfullscreen></iframe>
					</div>
