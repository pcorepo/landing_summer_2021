...
<head>
	<title>Calendario dei corsi | Luiss Summer Schools 2020</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="row pb-2">
				<div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <p class="red-news">IL CALENDARIO 2021 E’ IN VIA DI DEFINIZIONE</p>
					<h2 class="section blue-luiss">Calendario Corsi 2020</h2>
				</div>
				<div class="col-12 col-md-8 mx-auto course">
					<div class="table-alert">
						<p class="small blue-luiss">Scorri la tabella in orizzontale per vedere il calendario di tutte le settimane</p>
					</div>
				</div>
				<div class="col-12" style="overflow-x:auto;">
					...
					<table width="100%">
						<tr>
							<th></th>
							<th>
								<p class="small blue-luiss"><strong>14 giugno<br />19 giugno</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>21 giugno<br />26 giugno</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>28 giugno<br />3 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>5 luglio<br />10 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>12 luglio<br />17 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>19 luglio<br />24 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>31 agosto<br />4 settembre</strong></p>
							</th>
                             <th>
								<p class="small blue-luiss"><strong>7 settembre<br />11 settembre</strong></p>
							</th>
						</tr>
						<tr>
							<th>
								<p class="small blue-luiss">Luiss Summer School<br /><strong>Orientation 4</strong></p>
							</th>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano*</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Inglese*</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano*</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
							...
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano</del>*<sup style="color:#e40137"><b>COMPLETO</b></sup></p>
								<p class="blue-luiss-bg white small p-1 mx-1"><del>Inglese</del>*<sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
                            <td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
							 <td>
                                <p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano</p>
							</td>
						</tr>
						<tr>
							<th>
								<p class="small blue-luiss">Luiss Summer School<br /><strong>Orientation 3</strong></p>
							</th>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1"><del>Italiano*</del><sup style="color:#e40137"><b>COMPLETO</b></sup></p>
							</td>
						...
						<tr>
							<th>
								<p class="small blue-luiss">Luiss Summer School<br /><strong>Writing</strong></p>
							</th>
							<td></td>
							<td>
			...
			<p class="small blue-luiss">*la settimana si svolgerà on line a distanza</p>
