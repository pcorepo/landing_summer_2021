        ...
        <div id="news" class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
					<p class="blue-luiss"><?php echo $news['data_di_pubblicazione'] ?></p>
                    <h2 class="section blue-luiss"><?php echo $news['titolo'] ?></h2>
                </div>
				<!-- <div class="col-8 mx-auto photo-page " style="background-image:url('https://drive.google.com/uc?export=view&id=<?php echo $news['id_immagine'] ?>');"></div> -->
