...
<head>
    <title>Ammissione anticipata | Luiss Summer Schools 2020</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
                    <h2 class="section blue-luiss">Ammissione Anticipata</h2>
                    <p class="red-news">LE MODALITA’ DI AMMISSIONE ANTICIPATA SONO IN VIA DI DEFINIZIONE</p>
                </div>
                <div class="col-12 col-md-8 mx-auto course">
                    <p class="big blue-luiss">
                        Le Luiss Summer School consentono di avviare un <strong>percorso di ingresso in Luiss a partire dal terzultimo anno delle scuole superiori.</strong>
                    </p>

					<p class="big blue-luiss">
                        Gli studenti del <strong>terzultimo anno</strong> che frequentano la <strong><a href="orientation-3-summer-school.html">Orientation 3</a></strong> possono sostenere una prova di apprendimento che verte sugli argomenti trattati a lezione.
                        Il superamento di tale prova permette agli studenti di ottenere <strong>5 punti di bonus</strong> aggiuntivi sul punteggio del test di ammissione sostenuto l’anno successivo durante la Orientation 4 per <strong>l’ammissione anticipata</strong> alla Luiss.
                    </p>
					
                    <p class="big blue-luiss">
                        Gli studenti del <strong>penultimo anno</strong> che frequentano la <strong><a href="orientation-4-summer-school.html">Orientation 4</a></strong> possono sostenere il <strong>test di ammissione anticipata</strong> ai corsi di laurea Luiss.
                        Chi supera il test (raggiungendo la soglia di 55/100) potrà scegliere il corso di laurea a cui iscriversi entro l’autunno 2021.
                    </p>
