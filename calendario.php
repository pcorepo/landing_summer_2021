		...
		<div class="container">
			<div class="row pb-2">
				<div class="col-12 my-3 mt-md-5 col-md-8 mx-auto">
					<h2 class="section blue-luiss">Calendario Corsi 2021</h2>
				</div>
				...
				<div class="col-12" style="overflow-x:auto;">
					...
					<table width="100%">
						<tr>
							<th></th>
							<th>
								<p class="small blue-luiss"><strong>14 giugno<br />18 giugno</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>21 giugno<br />25 giugno</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>28 giugno<br />2 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>5 luglio<br />9 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>12 luglio<br />16 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>19 luglio<br />23 luglio</strong></p>
							</th>
							<th>
								<p class="small blue-luiss"><strong>30 agosto<br />3 settembre</strong></p>
							</th>
						</tr>
						<tr>
							<th>
							...
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano*</p>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Inglese*</p>
							</td>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano</p>
							</td>
							...
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano <img class="img-fluid ml-3" style="max-width:40px;" src="imgs/elements/logo-politecnico-di-bari.png"></p>
							</td>
							<td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano</p>
								<p class="blue-luiss-bg white small p-1 mx-1">Inglese</p>
							</td>
                            <td>
								<p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano* <img class="img-fluid ml-3" style="max-width:40px;" src="imgs/elements/logo-politecnico-di-bari.png"></p>
                            </td>
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><p class="blue-luiss-bg white small p-1 mx-1 my-1">Italiano</p></td>
							<td></td>
							<td></td>
							<td></td>
						</tr>
                        <tr>
							<th>
								<p class="small blue-luiss">Luiss Summer School<br /><strong>Coding 42</strong></p>
							</th>
							<td></td>
							<td></td>
							<td></td>
			...
			<p class="small blue-luiss">*la settimana si svolgerà in presenza e a distanza</p>
