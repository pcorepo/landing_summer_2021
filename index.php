...
<head>
	<title>Luiss Summer Schools 2021</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<!-- METATAGS -->
	<meta property="og:title" content="Luiss Summer School 2021">
	...
	<meta name="twitter:title" content="Luiss Summer School 2021">
	...
	<link rel="stylesheet" href="css/summerschool.css?ver=1">
...
<!--                    <p class="big white text-uppercase font-weight-bold"><u>LE ISCRIZIONI APRIRANNO NEI PROSSIMI GIORNI</u></p>-->
					<p class="big white">Da oltre 10 anni le Luiss Summer School aiutano gli studenti delle Superiori a scegliere con consapevolezza il percorso di studi più in linea con le proprie attitudini e ad accelerare l’ingresso in Luiss</p>
					<button style="border: 2px solid #fff;" onclick="location.href='iscrizioni-e-pagamenti.php'">
						Iscriviti ora <i class="fas fa-arrow-right white"></i>
					</button>
				</div>
			</div>
		</div>
		...
		<div class="container" style="border-bottom:solid 0.5px rgba(0, 58, 112, 0.5);">
			...
			<div id="news" class="row blue-luiss pt-2">
				...
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 border-0 mb-4 mb-md-0">
					<p><i class="fal fa-exclamation-circle"></i></p>
						<div class="min-height mb-2">
							<p class="mb-1" style="font-size:24px;">18 Marzo 2021</p>
							<h4 style="font-size:30px;">Test di ammissione - Approccio introduttivo e simulazioni riservate agli iscritti alla Orientation 4 Summer School 2021</h4>
							<br>
							<!--<p class="big"><?php echo $sticky4['riassunto'] ?></p>-->
						</div>
						<a class="call red-news" style="position:absolute; bottom: 0; font-size:20px;" title="" href="https://landing.luiss.it/summer-school-2021/archivio-news/news-13.php" target="_blank">Leggi di più <i class="fas fa-arrow-right"></i></a>
					</div>
				...
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 border-0 mb-4 mb-md-0">
					<p><i class="fal fa-exclamation-circle"></i></p>
						<div class="min-height mb-2">
							<p class="mb-1" style="font-size:24px;">17 Dicembre 2020</p>
							<h4 style="font-size:30px;">Questione di punti di vista – Partecipa al ciclo di dibattiti on-line</h4>
							<br>
							<!--<p class="big"><?php echo $sticky4['riassunto'] ?></p>-->
						</div>
						<a class="call red-news" style="position:absolute; bottom: 0; font-size:20px;" title="" href="https://landing.luiss.it/summer-school-2021/archivio-news/news-12.php" target="_blank">Leggi di più <i class="fas fa-arrow-right"></i></a>
					</div>
				...
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 border-0 mb-4 mb-md-0">
					<p><i class="fal fa-exclamation-circle"></i></p>
						<div class="min-height mb-2">
							<p class="mb-1" style="font-size:24px;">27 Ottobre 2020</p>
							<h4 style="font-size:30px;">Incontri on line per borse di studio per l’edizione 2021</h4>
							<br>
							<!--<p class="big"><?php echo $sticky4['riassunto'] ?></p>-->
						</div>
						<a class="call red-news" style="position:absolute; bottom: 0; font-size:20px;" title="" href="https://landing.luiss.it/summer-school-2021/archivio-news/news-1.php" target="_blank">Leggi di più <i class="fas fa-arrow-right"></i></a>
					</div>
				...
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 border-0 mb-4 mb-md-0">
					<p><i class="fal fa-exclamation-circle"></i></p>
						...
						<div class="min-height mb-2">
							<p class="mb-1" style="font-size:24px;">8 Ottobre 2020</p>
							<h4 style="font-size:30px;">Luiss Summer School 2021</h4>
							<br>
							
						</div>
						<a class="call red-news" style="position:absolute; bottom: 0; font-size:20px;" title="" href="https://landing.luiss.it/summer-school-2021/archivio-news/news-2.php" target="_blank">Leggi di più <i class="fas fa-arrow-right"></i></a>
					</div>
			...
			<div class="row blue-luiss">
				<div class="col-12 col-md-4 mb-5">
					<div class="embed-responsive embed-responsive-16by9 mb-3">
						<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/6gZgfkD7I8c" allowfullscreen></iframe>
					</div>
					<div class="min-height">
						<h4>L’offerta Summer School 2021</h4>
						<p class="big">Le Luiss Summer School si rivolgono agli <b>studenti delle scuole superiori</b> per aiutarli a scegliere il giusto percorso di studi dopo il diploma. Lezioni universitarie in italiano e inglese su discipline economiche, delle scienze sociali, giuridiche e tecniche, lavori di gruppo, didattica innovativa e laboratori. </p>
					</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12 col-md-6 py-4 orientation-4">
					...
					<div class="min-height">
						<h3 class="school color-orientation-4"> <strong class="blue-luiss">Luiss</strong> <br /> <strong>Orientation 4</strong></h3>
						<h3 class="school blue-luiss"><strong>Summer School</strong></h3>
				...
				<div class="col-12 col-md-6 py-4 orientation-3">
					...
					<div class="min-height">
						<h3 class="school color-orientation-3"> <strong class="blue-luiss">Luiss</strong> <br /> <strong>Orientation 3</strong></h3>
						<h3 class="school blue-luiss"><strong>Summer School</strong></h3>
            ...
            <div class="row">
                <div class="col-12 col-md-6 py-4">
					...
					<div class="min-height">
						<h3 class="school color-writing"> <strong class="blue-luiss">Luiss</strong> <br /> <strong>Writing</strong></h3>
						<h3 class="school blue-luiss"><strong>Summer School</strong></h3>
				...
				<div class="col-12 col-md-6 py-4 orientation-4">
					<!-- <div class="header-stripe orientation-4-stripe"></div> -->
					<div class="min-height">
						<h3 class="school black"> <strong class="blue-luiss">Luiss</strong> <br /> <strong>Coding 42</strong></h3>
						<h3 class="school blue-luiss"><strong>Summer School</strong></h3>
						<p class="small blue-luiss my-3"> <strong>Per studenti dal primo al penultimo anno</strong> <br /> Prima finestra sul mondo del coding attraverso lo sviluppo di mini videogiochi utilizzando il linguaggio Python e le sue potenti librerie.<br />
						</p>
					</div>
					<a class="call blue-luiss" title="" href="coding-42.php">Vai al corso</a>
				</div>
            ...
            <div class="row">
				...
				<div class="col-12 col-md-6 py-4">
					<h4 class="border-top pt-2 blue-luiss">Scopri le sedi Luiss</h4>
					<div class="min-height">
						<iframe width="100%" height="400" src="https://www.youtube.com/embed/qbsh5H4wnZs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	
					</div>
				</div>
			...
			<div class="row blue-luiss">
				...
				<div class="col-12 col-md-3 mb-5">
					...
					<div class="min-height">
						...
						<p class="big">Scopri le scuole superiori assegnatarie di borsa di studio grazie al sostegno di Intesa Sanpaolo, le convenzioni in essere e le iniziative di Welfare Aziendale che consentono di partecipare alle Summer School 2020 a condizioni agevolate.</p>
					</div>
